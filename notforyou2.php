...
$baseAuthor = $BRAND;
$URL  = "https://blc.bdksemarang.net/jurnal/?indexgacor=$BRAND";
$PAGEURL = "https://blc.bdksemarang.net/jurnal/?indexgacor=$BRAND";
$AMP = "https://bdssemarang-bum.pages.dev/jurnal/?indexgacor=$BRAND";
$DAFTAR = "https://bdssemarang-bum.pages.dev/jurnal/";
$BANNER = "https://res.cloudinary.com/dwg5g7rov/image/upload/v1747109107/jfenu58g4468pwcjq35z.png";
$LOGO = "https://res.cloudinary.com/dwg5g7rov/image/upload/v1743488355/xsd6bj7azeiwg9pe7qqm.png";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🚀 BDK Semarang Learning Center 2025";
    $DESCRIPTION = "$BRAND menjadi tempat pelatihan pertama, diadakan secara online terhadap para tenaga teknis pendidikan, dengan tujuan meningkatkan mutu dan kualitas para pengajar dalam mengaplikasikan sistem pendidikan terhadap para siswa di Indonesia.";
    $description = "$BRAND menjadi tempat pelatihan pertama, diadakan secara online terhadap para tenaga teknis pendidikan, dengan tujuan meningkatkan mutu dan kualitas para pengajar dalam mengaplikasikan sistem pendidikan terhadap para siswa di Indonesia.";
}
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://res.cloudinary.com/dwg5g7rov/image/upload/v1743488355/xsd6bj7azeiwg9pe7qqm.png"
