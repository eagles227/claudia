...
$baseAuthor = $BRAND;
$URL  = "https://adadimalang.com/berita/?googleindex=$BRAND";
$PAGEURL = "https://adadimalang.com/berita/?googleindex=$BRAND";
$AMP = "https://adadimalang-718.pages.dev/berita/?googleindex=$BRAND";
$DAFTAR = "https://adadimalang-718.pages.dev/berita/";
$BANNER = "https://res.cloudinary.com/dmxfczgyh/image/upload/v1750503442/banner-tunnel_u7jcaw.jpg";
$LOGO = "https://res.cloudinary.com/dmxfczgyh/image/upload/v1750411543/slot_gacor_xtruuc.png";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND 🚀 WEBSITE PENYEDIA INFORMASI BERITA TERLENGKAP INDONESIA ADADIMALANG";
    $DESCRIPTION = "$BRAND merupakan website resmi informasi yang menyediakan berbagai macam berita mulai dari, pendidikan, pemerintahan, ekbis, Entertainment, dan berita hiburan lainnya yang lengkap dan terpercaya. Adadimalang menjadi situs berita dirating bagus karena memberikan informasi yang tepat, akurat dan hangat untuk dibaca bagi seluruh masyarakat Indonesia.";
    $description = "$BRAND merupakan website resmi informasi yang menyediakan berbagai macam berita mulai dari, pendidikan, pemerintahan, ekbis, Entertainment, dan berita hiburan lainnya yang lengkap dan terpercaya. Adadimalang menjadi situs berita dirating bagus karena memberikan informasi yang tepat, akurat dan hangat untuk dibaca bagi seluruh masyarakat Indonesia.";
}
